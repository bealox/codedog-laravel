...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			...
			<div class="form-group">
				<label> Title </label>
				{{Form::text('title', Input::old('title') , array('id' =>'title', 'class' => 'form-control input-lg center-block', 'style' => 'width:100%;'))}}
			</div>
			<div class="form-group">
				<label>Body</label>
				{{Form::textarea('body',Input::old('body'), array('id' => 'body', 'class' => 'form-control' ))}}
			</div>
			<div class="form-group">
				<label>Breed</label>
