	...
	<div class="list-group">
		@foreach($actives as $active)
			<div class="list-group-item">
				...
				<div class="list-group-item-text-right text-danger" style="text-align:right; display:inline-block; width:80%;">expiry date: {{Date::parse($active->created_at)->format('d/m/Y')}}
				</div>
				<div class="dropdown" style="display:inline-block;">
				  ...
				  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
				    <li role="presentation"><button role="menuitem" tabindex="-1" class="btn-link" href="#">
					<i class="fa fa-pencil fa-fw"></i>
					Edit</button></li>
    {{ Form::open(array('route' => array('profile.post.destroy', $active->id), 'method' => 'delete')) }}
				    <li role="presentation"><button role="menuitem" tabindex="-1" class="btn-link" onclick="return confirm('are you sure?');" >
